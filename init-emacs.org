...
- gptel と コーディングエージェント(agent-shell) で agent-browserを利用している
  - [[https://github.com/vercel-labs/agent-browser][agent-browser Browser automation CLI for AI agents. Fast native Rust CLI.]]
...
エージェントごとに追加でソフトウェアのインストールが必要

- codex
  - npm i -g @openai/codex
  - npm i -g @zed-industries/codex-acp
- Claude Code
  - [[https://code.claude.com/docs/en/overview][Claude Agent]] or npm install -g @anthropic-ai/claude-code
